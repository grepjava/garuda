...
| 4 | Groups, 405, middleware, response hooks, routers, fallbacks, shipped middleware | CORS, authentication, the application log, response observers, request limits, cookies, sessions, CSRF protection and security headers done; path normalization, decompression and host and IP filters to do |
...
**Step 4**
- Middleware Garuda ships: path normalization, request decompression, a host
  allow-list and IP filter.
