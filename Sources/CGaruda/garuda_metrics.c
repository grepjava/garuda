/* ---------------------------------------------------------------------------
 * The shared counter page. See garuda_metrics.h for why it exists.
 * ------------------------------------------------------------------------- */
#define _GNU_SOURCE

#include "garuda_metrics.h"
...
/* initial-exec for the reason given at g_current_worker in garuda_extra.c. */
